...
signuptwo( String formno){
    ...
    submit.setBounds(120,670,250,30);
    ...
    cancel.setBounds(400,670,250,30);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==submit){
            ...
            try{
             ...
             setVisible(false);
             new Minor_Project().setVisible(true);
        }
    }
